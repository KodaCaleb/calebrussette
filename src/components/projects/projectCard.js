...
export default function ProjectCard({ project }) {
    ...
    return (
        <div className=" md:ml-2 text-themeWhite card-background max-h-full border-themeBlack rounded-xl self-center justify-center flex-col flex h-auto md:w-auto ">
